...
// // // Routes pour les idées bon
// // Route::resource('idees', IdeeController::class);

// // // Routes pour les catégories bon
// // Route::resource('categories', CategorieController::class);

// // // Routes pour les commentaires sous une idée spécifique
// // Route::resource('idees.commentaires', CommentaireController::class);
